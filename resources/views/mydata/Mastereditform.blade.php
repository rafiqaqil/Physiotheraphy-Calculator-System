...
<div class="container">
       ...
       <a href='{{ env("absolute")}}/ShowMyDataMaster'><button class='btn btn-warning'>Cancel</button></a>
    <form action='{{env("absolute")}}/{{$user->id}}/editMydata/{{ $mydata -> id }}/MasterServerUpdate' enctype="multipart/form-data" method="post">
        @csrf
        @method('PATCH')
