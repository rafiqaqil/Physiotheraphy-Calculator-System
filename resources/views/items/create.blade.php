...
<div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5 ">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Item & Costing</h3></div>
                                    <div class="card-body">
                                         <form action="../../{{$quote->id}}/StoreItem" enctype="multipart/form-data" method="post">
                                            @csrf
                                              <h5>General </h5>
                                            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                                                ...
                                                <div class="col-md-12">
                                                 <div class="form-group">
                                                        ...
                                                        <input name="ITEM_NAME" class="form-control py-1" id="ITEM_NAME" type="text" placeholder="ITEM_NAME">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value=1 name="EXCHANGE_RATE" class="form-control py-1" id="ITEM_NAME" type="text" placeholder="EXCHANGE_RATE">
                                           ...
                                           <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input value=1 name="QTY" class="form-control py-1" id="ITEM_NAME" type="text" placeholder="QTY">
                                                                    @if ($errors->has('QTY'))
                                                                    <span class="invalid-feedback" role="alert">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value=1 name="COST_PER_UNIT" class="form-control py-1" id="ITEM_NAME" type="text" placeholder="COST_PER_UNIT">
                                            ...
                                            <hr style="height:2px;border-width:0;color:gray;background-color:gray">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input value=0 name="CHARGER_COMMISION" class="form-control py-1" id="CHARGER_COMMISION" type="text" placeholder="QTY">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value=0 name="CHARGER_TRAINING" class="form-control py-1" id="ITEM_NAME" type="text" placeholder="CHARGER_TRAINING">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value=0 name="CHARGER_DELIVERY" class="form-control py-1" id="CHARGER_DELIVERY" type="text" placeholder="CHARGER_DELIVERY">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value=0 name="CHARGER_OTHER" class="form-control py-1" id="ITEM_NAME" type="text" placeholder="CHARGER_OTHER">
                                                ...
                                                <div class="col-md-12">
                                                 <div class="form-group">
                                                        ...
                                                        <input name="MARGIN" class="form-control py-1" id="MARGIN" type="float" placeholder="MARGIN">
