    ...
    <form action="/addTrans" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="row">
                    <h1>Add DOC Transactions</h1>
                </div>
                
                
              <input name="group" id="group" value="DOC"  hidden="true">  
                ...
                <div class="form-group row">
                    ...
                    <select id="category"
                        ...
                        <option value="Acquire New Assets Land">Acquire New Assets Land</option>
                        <option value="Acquire New Assets Machinery ">Acquire New Assets Machinery</option>
                        <option value="Acquire New Assets Vehicle">Acquire New Assets Vehicle</option>
